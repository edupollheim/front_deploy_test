...
const MenuBar = () => {
    ...
    const menuLinkClasses =
        "menuLink flex flex-col items-center text-gray-800  hover:filter hover:invert-50 hover:sepia hover:saturate-500 hover:hue-rotate-190";
        ...
        <nav className="p-4 bg-gray-100">
            <div className="flex justify-between items-center md:hidden">
                <button
                    ...
                    className="text-gray-800  focus:outline-none opacity-100"
                >
