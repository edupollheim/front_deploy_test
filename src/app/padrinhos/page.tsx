...
export default function Padrinhos() {
    ...
    return (
        <>
            <h2 className="text-4xl font-thin text-center mb-8 pt-4 text-[#d6b293] text-[3.5rem]" style={{ fontFamily: "'Fleur De Leah'" }}>
                Nossos Padrinhos
            </h2>
            <div className="container mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-24">
                    ...
                    <div className="flex flex-col justify-center items-start text-lg leading-relaxed space-y-4 pl-6 pr-6 text-[#637c8b]" style={{ fontFamily: "'Inter'",  fontWeight: 100}}>
                        <h2 className="text-3xl mb-4 text-[#d6b293] text-center" style={{ fontFamily: "'Inter'", fontWeight: 400, fontSize: '1.5rem' }}>
                            Aos nossos amados padrinhos:
                        </h2>
                        <p className="text-justify" style={{ fontFamily: "'Inter'" }}>
                        ...
                        <br />
                        <p className="mt-6 font-bold text-xl text-center text-[#d6b293]" style={{ fontFamily: "'Inter'", fontWeight: 400, fontSize: '1.25rem' }}>Com todo o carinho,</p>
                        <p className="font-thin text-[3rem] mt-4 text-center text-[#d6b293]" style={{ fontFamily: "'Fleur De Leah'" }}>
                            Eduardo & Jéssica
                        </p>
                        <br />
                        <br />
